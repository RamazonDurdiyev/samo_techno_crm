...
class ProductsBloc extends Bloc<ProductsEvent, ProductsState> {
 final  ProductRepo repo;
  ProductsBloc({required this.repo}) : super(Initial()) {
  ...
  _changeTab(Emitter<ProductsState> emit, int value) async {
    try {
  ...
  _tryToExpand(Emitter<ProductsState> emit, int index) {
    try {
  ...
  _saveLocalToCart(
      Emitter<ProductsState> emit, CartProductModel product) async {
    try {
  ...
  _fetchCategoryById(Emitter<ProductsState> emit, int id) async {
    try {
