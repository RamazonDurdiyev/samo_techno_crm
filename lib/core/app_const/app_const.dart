...
const String BASE_URL = "https://a285-213-230-65-9.ngrok-free.app/";
...
const String POST_PRODUCT_API = "${BASE_URL}v1/products/add";
...
const String DELETE_PRODUCTS_API =
    "${BASE_URL}product-api/v1/out-products/sell";
...
const String SEARCH_CATEGORIES_API = "v1/categories/search/";
const String SEARCH_ADDRESS_API = "v1/trade/search/BUY/";
